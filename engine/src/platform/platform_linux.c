	...
	while (XPending(platform.impl->display)) {
		...
		case KeyPress: {
			const KeySym key_sym = XkbKeycodeToKeysym(
				platform.impl->display, event.xkey.keycode, 0,
...
b8 keysym_to_keycode(KeySym key_sym, enum keycode *key_code)
{
	...
	switch (key_sym) {
	case 'a':
		key_code_out = KEYCODE_A;
		break;
	case 'b':
		key_code_out = KEYCODE_B;
		break;
	case 'c':
		key_code_out = KEYCODE_C;
		break;
	case 'd':
		key_code_out = KEYCODE_D;
		break;
	case 'e':
		key_code_out = KEYCODE_E;
		break;
	case 'f':
		key_code_out = KEYCODE_F;
		break;
	case 'g':
		key_code_out = KEYCODE_G;
		break;
	case 'h':
		key_code_out = KEYCODE_H;
		break;
	case 'i':
		key_code_out = KEYCODE_I;
		break;
	case 'j':
		key_code_out = KEYCODE_J;
		break;
	case 'k':
		key_code_out = KEYCODE_K;
		break;
	case 'l':
		key_code_out = KEYCODE_L;
		break;
	case 'm':
		key_code_out = KEYCODE_M;
		break;
	case 'n':
		key_code_out = KEYCODE_N;
		break;
	case 'o':
		key_code_out = KEYCODE_O;
		break;
	case 'p':
		key_code_out = KEYCODE_P;
		break;
	case 'q':
		key_code_out = KEYCODE_Q;
		break;
	case 'r':
		key_code_out = KEYCODE_R;
		break;
	case 's':
		key_code_out = KEYCODE_S;
		break;
	case 't':
		key_code_out = KEYCODE_T;
		break;
	case 'u':
		key_code_out = KEYCODE_U;
		break;
	case 'v':
		key_code_out = KEYCODE_V;
		break;
	case 'w':
		key_code_out = KEYCODE_W;
		break;
	case 'x':
		key_code_out = KEYCODE_X;
		break;
	case 'y':
		key_code_out = KEYCODE_Y;
		break;
	case 'z':
		key_code_out = KEYCODE_Z;
		break;

	case XK_0:
		key_code_out = KEYCODE_0;
		break;
	case XK_1:
		key_code_out = KEYCODE_1;
		break;
	case XK_2:
		key_code_out = KEYCODE_2;
		break;
	case XK_3:
		key_code_out = KEYCODE_3;
		break;
	case XK_4:
		key_code_out = KEYCODE_4;
		break;
	case XK_5:
		key_code_out = KEYCODE_5;
		break;
	case XK_6:
		key_code_out = KEYCODE_6;
		break;
	case XK_7:
		key_code_out = KEYCODE_7;
		break;
	case XK_8:
		key_code_out = KEYCODE_8;
		break;
	case XK_9:
		key_code_out = KEYCODE_9;
		break;

	case XK_F1:
		key_code_out = KEYCODE_F1;
		break;
	case XK_F2:
		key_code_out = KEYCODE_F2;
		break;
	case XK_F3:
		key_code_out = KEYCODE_F3;
		break;
	case XK_F4:
		key_code_out = KEYCODE_F4;
		break;
	case XK_F5:
		key_code_out = KEYCODE_F5;
		break;
	case XK_F6:
		key_code_out = KEYCODE_F6;
		break;
	case XK_F7:
		key_code_out = KEYCODE_F7;
		break;
	case XK_F8:
		key_code_out = KEYCODE_F8;
		break;
	case XK_F9:
		key_code_out = KEYCODE_F9;
		break;
	case XK_F10:
		key_code_out = KEYCODE_F10;
		break;
	case XK_F11:
		key_code_out = KEYCODE_F11;
		break;
	case XK_F12:
		key_code_out = KEYCODE_F12;
		break;

	case XK_Shift_L:
		key_code_out = KEYCODE_SHIFT;
		break;
	case XK_Control_L:
		key_code_out = KEYCODE_CTRL;
		break;
	case XK_Alt_L:
		key_code_out = KEYCODE_ALT;
		break;
	case XK_Caps_Lock:
		key_code_out = KEYCODE_CAPSLOCK;
		break;
	case XK_Tab:
		key_code_out = KEYCODE_TAB;
		break;
	case XK_Return:
		key_code_out = KEYCODE_ENTER;
		break;
	case XK_space:
		key_code_out = KEYCODE_SPACE;
		break;
	case XK_BackSpace:
		key_code_out = KEYCODE_BACKSPACE;
		break;
	case XK_Escape:
		key_code_out = KEYCODE_ESC;
		break;

	case XK_Left:
		key_code_out = KEYCODE_LEFT;
		break;
	case XK_Right:
		key_code_out = KEYCODE_RIGHT;
		break;
	case XK_Up:
		key_code_out = KEYCODE_UP;
		break;
	case XK_Down:
		key_code_out = KEYCODE_DOWN;
		break;
